...
def assert_is_above(above, below):
    kvaut.client.assert_is_visible(above)
    kvaut.client.assert_is_visible(below)
...
def launch_ci_screen(context, fake_time = None):
    ...
    context.app_process = subprocess.Popen([context.app_path], **kwargs)
